...
function Coffee(size, isDecaf, cream, sugar) {
    ...
    this.description = function() {
        output.textContent = `A ${this.size} ${(this.isDecaf === true? "decafinated" : "caffinated")} coffee with ${this.cream} creams and ${this.sugar} tsp of sugars`;
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let scottsCoffee = new Coffee("XL", false, 2, 1);
...
let lukesCoffee = new megansCoffee.constructor("S", false, 3, 4);
