...
let myArray = ['string', 43, true, [0, 1, 2]];
...
output.textContent = "The third element is " + myArray[2];

// You can also change a particular element
myArray[2] = false;
output.textContent = "The changed third element is " + myArray[2];
...
let origFiveString1 = "Toronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montreal Canadians";
...
let origFiveString2 = origFiveArray.join(' - '); //most recommended as you can specify how you want it split
...
let sevenArray = origFiveArray.push('New York Rangers', 'Philidelphia Flyers'); //sevenArray returns the size of the new array while origFiveArray contains the items
console.log(sevenArray);
console.log(origFiveArray);

// Adding one or more items to an array with push()

// If you would like to capture how many elements are in the array after you have edited it, that's what sevenArray is

// Removing an item from an array with pop()
let poppedArray = origFiveArray.pop();
console.log(origFiveArray);
...
sevenArray = origFiveArray.unshift('Buffalo Sabres');
console.log(sevenArray);
console.log(origFiveArray);

sevenArray = origFiveArray.shift(); //returns removed item
console.log(sevenArray);
console.log(origFiveArray);
...
//removing
sevenArray = origFiveArray.splice(2, 2);//starting at index 2, going for 2 items to delete them
console.log(sevenArray);
console.log(origFiveArray);
//adding
sevenArray = origFiveArray.splice(2, 0, 'A', 'B'); //the second number always refers to how many are deleted (so 0 if adding)
console.log(sevenArray);
console.log(origFiveArray);
