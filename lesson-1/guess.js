...
function checkGuess() {
    ...
    // STEP 3c: If this is not the first guess, add some text to the screen as a label for listing previous guesses for reference
    if (guessCount === 1) {
...
function gameOver() {
    ...
    lowOrHi.textContent = 'Game Over! Refresh the page to restart';
}
