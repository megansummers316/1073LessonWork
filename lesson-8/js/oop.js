...
Album.prototype.describe = function() {
    let describe = `The album is called ${this.name} by ${this.artist} in ${this.year} with ${this.numTracks} tracks on it`;
    return describe;
}

/* STEP 3b: Instantiate a new Album (or 2) based on the above constructor */
let album2 = new Album("Thrillers");
let album3 = new Album("Back in Black");
let album4 = new Album("Thunderstruck", "AC/DC", 1990, 15);
